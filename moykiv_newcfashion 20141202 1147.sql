...
-- Дата скрипта: 02.12.2014 11:47:53
-- Версия сервера: 5.5.40-cll
-- Версия клиента: 4.1
--
...
CREATE TABLE Products (
  ...
  is_view TINYINT(1) DEFAULT 1 COMMENT 'Отображать товар в выдаче',
...
-- Таблица moykiv_newcfashion.Categories не содержит данных
